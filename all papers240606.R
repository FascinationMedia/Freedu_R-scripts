...
#
DOE_PastPaper_Exam_URLs <- filter(DOE_PastPaper_Exam_URLs,!is.na(DOE_PastPaper_Exam_URLs$Sitting))
...
DF_final <- DF_final %>% arrange(Subject, Exam_Year, Paper_Language)

write.csv(DF_final,"MultipleChoice_QPs.csv", row.names = FALSE)
#
